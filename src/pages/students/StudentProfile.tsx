...
import { formatDate, formatCurrency, getInitials, generateWhatsAppUrl } from '@/lib/utils'
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                  ...
                  <span className="flex items-center gap-1.5">
                    <Calendar className="h-3.5 w-3.5" /> Admitted {formatDate(student.admission_date)}
                  </span>
                </div>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <Card className="bg-blue-50/50 border-blue-100 dark:bg-blue-950/30 dark:border-blue-900">
                <CardContent className="p-4">
                  ...
                  <p className="text-xl font-bold font-heading">{formatCurrency(fee?.total_fee || 0)}</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-red-50/50 border-red-100 dark:bg-red-950/30 dark:border-red-900">
                <CardContent className="p-4">
                  ...
                  <p className="text-xl font-bold font-heading text-red-700 dark:text-red-400">{formatCurrency(fee?.remaining || 0)}</p>
                </CardContent>
              </Card>
            </div>
